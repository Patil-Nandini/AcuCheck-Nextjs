        ...
        <nav className="hidden lg:flex space-x-8 text-white font-medium ">
          <div className="relative group">
            ...
            >
              ...
              >
                <h4 className="text-[#000000D9] font-semibold mb-4 uppercase text-sm ">
                  Products
                </h4>
          ...
          <span className="font-semibold text-md cursor-pointer text-[#000000D9]">
            Use Cases
          </span>
          <span className="font-semibold text-md cursor-pointer text-[#000000D9]">
            Developer
          ...
          <span className="font-semibold text-md cursor-pointer text-[#000000D9]">Login</span>
        </nav>
