...
const testimonials = [
  {
    ...
    avatar: "/Avatar.png",
    comment: "We stopped relying on outdated credit data the day we saw what AcuCheck could do.",
  },
  {
    name: "Ashley M",
    ...
    avatar: "/Avatar-1.png",
    comment:
      "For any lender who wants real-time data - AcuCheck is a must-have.",
  },
  {
    name: "David M",
    ...
    avatar: "/Avatar-2.png",
    comment:
      "Credit scores are outdated -AcuCheck shows us a customer’s real ability to pay",
  },
];
